...
Each API key has a permissions bitmask that controls its capabilities. See the [Permissions Reference](/permissions) for a complete list.
...
- [Endpoints](/endpoints)
- [View all permissions](/permissions)
- [Handle errors](/error-codes)
