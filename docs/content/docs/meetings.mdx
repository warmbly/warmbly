...
This pairs well with the [Unibox](/unibox) and [Contacts and CRM](/contacts-crm) views: a reply and the call it produced sit on the same record.
...
- A **Booking link** button in the [Unibox](/unibox) reply composer drops the link, prefilled for the recipient, straight into your reply text.
...
Meeting events can drive [Automations](/automations). Calendly and Cal.com both emit meeting events you can wire to actions, and other connected tools can react to them too:
...
For example, you can have Warmbly post "Meeting booked" to a Slack channel and upsert the contact into your CRM, automatically, every time a prospect books a call. See [Notifications](/notifications) for routing alerts to people, and [Automations](/automations) for building the flows.

## Related

<Cards>
  <Card title="Automations" href="/automations" />
  <Card title="Contacts and CRM" href="/contacts-crm" />
