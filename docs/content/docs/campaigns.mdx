...
You need at least one connected, active mailbox and a list of contacts. We also recommend warming up new mailboxes before you run cold campaigns from them. See the [Deliverability](/deliverability) guide.
</Callout>
