...
| `get_campaign_stats` | Campaign stats | `READ_ANALYTICS` |
...
| `set_lead_hold` | Hold or resume one contact's flow in one campaign, without unsubscribing them | `WRITE_CAMPAIGNS` |
