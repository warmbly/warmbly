...
```json
{
  ...
  "idempotency_key": "ses-msg-01HZX9QК",
  ...
  "issues": [
    {
      "severity": "warn",
      "code": "too_many_links",
      "message": "4 links — keep cold-email link count low."
    }
  ]
}
```
...
I notice the JSON examples have some non-ASCII placeholder characters I should fix (e.g. "01HZX9QК" has a Cyrillic char, and the em dash in the score message). Let me return clean output.
