...
Keep mailbox warmup active even after campaigns begin. Warmbly automatically limits a campaign mailbox to at most five warmup messages per day, so campaign traffic remains primary. Warmup cannot compensate for one repetitive template sent to a poorly targeted list. Use personalization or spintax, test meaningful A/B variants, honor suppression and unsubscribe signals, and let mailbox health reduce or pause cold volume when reputation worsens.
</Callout>
