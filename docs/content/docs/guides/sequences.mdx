...
- An out-of-office message does, on its own, hold the contact's next step until they are back, so the follow-up is not sent to an empty desk. See [out of office and pausing one lead](/guides/campaigns/#out-of-office-and-pausing-one-lead).
