...
The connection requests only the scopes the triggers and actions need (reading and writing contacts, campaigns, the inbox, CRM records, and templates). It does not request billing or team-management access.
