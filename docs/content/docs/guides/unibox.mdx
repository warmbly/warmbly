...
The same AI experience as replies lives in the compose body: **⌘J** at the cursor to write inline or **Draft this email with AI** (grounded in the recipient's contact record), select text to **Edit with AI**, and a sparkle next to the subject field suggests a subject line from what you wrote. Sends can also be scheduled with the same presets as replies.
