...
Press **Draft reply** in the composer and Warmbly writes a first draft for you. The draft is grounded in the full thread, what Warmbly knows about the contact (their details and which campaigns they are in), and your workspace **voice profile**, so it answers the actual message in your voice rather than a generic template. The draft types itself into the composer and a review bar appears above the body: **Keep** it, **Retry** for a fresh take, **Adjust** to steer the redraft with an instruction ("shorter", "mention pricing"), or **Discard** to restore what you had. Nothing is sent until you press **Send** yourself. Each draft costs AI credits (see [AI credits](/guides/ai-credits/)).
