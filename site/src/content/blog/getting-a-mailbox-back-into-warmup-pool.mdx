...
- How you treated warmup mail, if you're on a pool. Deleting or spam-flagging warmup messages you received counts against you, because you are the only one who can do that; a token arriving in your inbox never does, since you did not put it there.
...
- Clean handling of received warmup mail: nothing deleted or flagged as spam.
